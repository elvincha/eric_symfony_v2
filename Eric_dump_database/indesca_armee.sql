...
CREATE TABLE `armee` (
  ...
  `nom_armee` varchar(50) NOT NULL,
  `trigramme_armee` varchar(10) NOT NULL,
...
LOCK TABLES `armee` WRITE;
/*!40000 ALTER TABLE `armee` DISABLE KEYS */;
INSERT INTO `armee` VALUES (1,'Armée de l\'Air et de l\'Espace','AAE'),(2,'Armée de Terre','ADT'),(3,'Marine','Marine'),(4,'Service InterArmées','SIA');
